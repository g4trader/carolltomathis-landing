    ...
    <div class="max-w-4xl mx-auto space-y-12">
        ...
        <?php else : ?>
            <div class="card-soft text-center py-12">
                <p style="color: rgba(249, 229, 216, 0.7); margin-bottom: 1rem;">
                    <?php _e('Nenhum resultado encontrado. Tente uma nova busca.', 'carolltomathis'); ?>
                </p>
                <?php get_search_form(); ?>
            </div>
        <?php endif; ?>
